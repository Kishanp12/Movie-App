...
<body class="font-sans text-white bg-gray-900">
    <nav class="border-b border-gray-800">
        <div class="container flex items-center px-4 py-6 mx-auto justify between">
            ...
            <div class="flex items-center">
                <div class="relative">
                    <input type="text" class="w-64 px-4 py-1 pl-8 text-sm bg-gray-800 rounded-full focus:outline-none focus:shadow-inner" placeholder="Search">
