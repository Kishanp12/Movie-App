...
@section('content')
    <div class="border-b border-gray-800 tv-info">
        <div class="container flex flex-col px-4 py-16 mx-auto md:flex-row">
            ...
            <div class="md:ml-24">
                <h2 class="mt-4 text-4xl font-semibold md:mt-0">{{ $tvshow['name'] }}</h2>
                                    ...
                                    <div class="bg-gray-900 rounded">
                                        ...
                                        <div class="px-8 py-8 modal-body">
                                            <div class="relative overflow-hidden responsive-container" style="padding-top: 56.25%">
                                                <iframe class="absolute top-0 left-0 w-full h-full responsive-iframe" src="https://www.youtube.com/embed/{{ $tvshow['videos']['results'][0]['key'] }}" style="border:0;" allow="autoplay; encrypted-media" allowfullscreen></iframe>
                                            </div>
                                        </div>
                                    </div>
                                </div>
